...
import { mockAirports, generateMockFlights, formatPrice } from "../types";
...
const FlightSearchApp: React.FC = () => {
  ...
  const handleBookNow = (flight: FlightResult) => {
    ...
    console.log(
      `Mock Booking successful for Flight ${flight.segments[0].flightNumber} on ${flight.airline}!`
    );
  };
      ...
      <Container maxWidth="lg" sx={{ mt: 4, mb: 4 }}>
        ...
        {bookingConfirmed && (
          <Alert severity="success" sx={{ mb: 2 }}>
            Booking for flight **{selectedFlight?.segments[0].flightNumber}**
